				...
				<div class = "col-sm col-lg-3 py-5 ">
					<div class="thumbnail text-center">
						...
						<figure class = " figure-caption border rounded ">
							...
							<img src="../images/appicon.png" class="figure-img img-fluid rounded" alt="placeholderimg." />
						</figure>
					</div>
				</div>
				...
				<div class = "col-sm col-lg-3 py-5">
					<div class="thumbnail text-center">
						...
						<figure class = " figure-caption border rounded">
							...
							<img src="../images/CMSicon.png" class="figure-img img-fluid rounded" alt="placeholderimg." />
						</figure>
					</div>
		</div>
			</div>
